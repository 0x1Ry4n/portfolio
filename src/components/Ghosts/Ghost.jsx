...
const Ghost = () => {
  return (
    <div class="container absolute bottom-0 left-[42%] transform translate-x-[-50%] justify-center md:justify-between xl:gap-[106%] md:gap-[25%] p-5 md:p-10 lg:p-10 top-[70%] hidden sm:flex">
